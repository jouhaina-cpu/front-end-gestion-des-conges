...
import { DepServiceService } from '../Service/dep-service.service';
 ...
 @Component({
  ...
  templateUrl: './modifier-dep.component.html',
  styleUrls: ['./modifier-dep.component.scss']
})
...
creeremploye() {
  const dialogRef = this.dialog.open(Dialogmodifier);
