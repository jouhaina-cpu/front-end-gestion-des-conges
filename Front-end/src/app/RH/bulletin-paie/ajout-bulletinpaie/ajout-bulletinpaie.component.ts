...
interface Role {
 ...
 @Component({
  ...
  templateUrl: './ajout-bulletinpaie.component.html',
  styleUrls: ['./ajout-bulletinpaie.component.scss']
})

 
export class AjoutBulletinComponent  implements OnInit {
...
//  création d' Employé
creeremploye() {
  const dialogRef = this.dialog.open(AjoutBulltein);
